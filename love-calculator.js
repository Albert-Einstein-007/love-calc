...
console.log(Lname)
				...
				if(Uname =="") {								document.getElementById("sh").innerHTML="Enter Your Name";
...
if (text > "10") {
  				...
  				document.getElementById("good").innerHTML = "SO SAAAD😂";
...
var Uname = document.getElementById("URname").innerHTML;

var Lname =	document.getElementById("LRname").innerHTML;
